...
import styles, {ICON_SIZE, ITEM_HEIGHT, colors} from './styles';
...
const Item: React.FC<ItemProps> = ({icon, color, name, showText}) => {
  return (
...
const ConnectButton: React.FC<ConnectButtonProps> = ({onPress}) => {
  return (
    <View
      style={{
        position: 'absolute',
